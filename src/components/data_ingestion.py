...
class DataIngestionConfig:
    train_data_path: str=os.path.join('data',"train.csv") #where to save the trainpart,testpart and datapart
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('data\class\Crop_details_local.csv')
            ...
            train_set,test_set=train_test_split(df,test_size=0.2,random_state=42,stratify=df['croplabel'])
